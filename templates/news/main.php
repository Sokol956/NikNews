...
<div class="main-page-wrapper">
	<section class="main-page-filters">
		<h1>Фильтры:</h1>
		<form name="sort" method="post" action="/page/1">
			<div>
	...
	<section class="main-page-news">
		<?php foreach ($news as $oneNews): ?>
			<article>
				<div class="news-wrap">
					...
					<div class="news-article"><a href="/news/<?= $oneNews->getId() ?>"><?= $oneNews->getName() ?></a></div>
		...
		<?php $i = 1; while ( $i <= $listCount) {?>
			<a class="pages" href="/page/<?php print($i) ?>"><?php print($i); ?></a>
		<?php $i++; }; ?>
		</div>
	</section>
</div>
